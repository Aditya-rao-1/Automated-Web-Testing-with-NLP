      ...
      <Element name="faq" className="relative">
        <div className="container ">
          <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2 bg-s1/50 pb-20 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
            <h3 className="h3 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-5 max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm">
              Curiosity didn't kill the cat, it gave it answers.
            </h3>
            <span className="text-p3 h6 mx-auto block text-center">
